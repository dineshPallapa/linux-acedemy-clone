        ...
        f.ensureModuleRegistered("SignalsFBEvents.plugins.opttracking", function() {
            return function(g, h, i, d) {
                ...
                (function() {
                    ...
                    function o() {
                        ...
                        for (var b in a)
                            if (b.match(/\$[a-z]dc_/) && a[b].cache_)
                                return !0;
                        if (g.external && g.external.toString && g.external.toString().indexOf("Sequentum") !== -1)
                            return !0;
                    ...
                    function p() {
                        if (q(["_phantom", "__nightmare", "callPhantom"]))
                            return !0;
                    ...
                    h = function() {
                        ...
                        i(d, [{
                            ...
                            value: function(a, b, c) {
                                ...
                                d && (d.userData && (a.userData = d.userData),
                                d.agent != null && d.agent !== "" ? a.set = {
                                    agent: d.agent
                    ...
                    function u(a, e) {
                        try {
                            ...
                            if (i && f < .01 || h === "canary") {
                                ...
                                c(a, Error) && (f.append("f", a.fileName),
                ...
                (function() {
                    ...
                    c = function c() {
                        ...
                        this.sendPOST = function(a, c, d) {
                            ...
                            if (f) {
                                a.append("exp", f.code);
                                if (f.isInExperimentGroup)
                                    return e._sendXHRPost(a, c, d)
                            }
                ...
                (function() {
                    ...
                    function b(c) {
                        ...
                        for (var d = 0; d < c.length; d++) {
                            ...
                            h = h[1];
                            if (f < 0 || f > 1)
                                throw new Error("passRate should be between 0 and 1 in " + e.name);
                            if (b >= i && b < h) {
                                i = a() < f;
                                return {
                                    name: e.name,
                ...
                (function() {
                    ...
                    function r(a, f, g, h, i) {
                        ...
                        if (a != null) {
                            ...
                            k && p === 0 && a.isInExperimentGroup && (d.logStartBatch(),
                            setTimeout(q, 0));
        ...
        f.ensureModuleRegistered("SignalsFBEvents", function() {
            return function(g, h, i, j) {
                ...
                (function() {
                    ...
                    var H = {}, I = -1, ca = Array.prototype.slice, J = Object.prototype.hasOwnProperty, K = i.href, L = !1, M = !1, N = [], O = {}, P;
                    h.referrer;
                    var Q = {
                        PageView: new e(),
                    ...
                    function U(a, b, c) {
                        ...
                        if (J.call(O, a)) {
                            b && B(O[a].userData) ? (O[a].userData = b,
                            $("identity")) : F({
                    ...
                    function W(a, b) {
                        for (var c = 0, d = N.length; c < d; c++) {
                            var e = N[c];
                            if (!(a === "PageView" && this.allowDuplicatePageViews) && Object.prototype.hasOwnProperty.call(Q, a) && Q[a].has(e.id))
                                continue;
                            Z(e, a, b);
                    ...
                    function ka(b, c) {
                        if (Object.prototype.hasOwnProperty.call(H, b))
                            return;
                        J.call(c, "__fbEventsPlugin") && c.__fbEventsPlugin === 1 && (H[b] = c,
                        H[b].plugin(a, R, u),
                        x("pluginLoaded", b));
                        G.releasePlugin(b)
                    }
