var UnifiedNav = {
  getHTML: function() {
    $.get("https://d3bm05a1cocdno.cloudfront.net/header.html", function(data) {
      $("#headerContainer").html(data), UnifiedNav.loadScript()
    })
  },
  loadScript: function() {
    var node = document.createElement("script");
    node.src = "https://d3bm05a1cocdno.cloudfront.net/header.js", node.type = "text/javascript", node.async = !0, node.charset = "utf-8", document.getElementsByTagName("head")[0].appendChild(node)
  },
  init: function() {
    isAuthenticated && UnifiedNav.getHTML()
  }
};
UnifiedNav.init();
